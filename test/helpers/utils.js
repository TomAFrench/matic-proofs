...
export const encodeStateSyncerData = (user, rootToken, amount) => `0x${
...
export const constructERC1155DepositData = (ids, amounts) => abi.encode(
  [
    'uint256[]',
    'uint256[]',
    'bytes',
...
export const { mnemonics } = packageJSON.config;
